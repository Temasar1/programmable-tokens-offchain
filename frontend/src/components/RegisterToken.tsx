...
import { registerProgrammableToken } from "../../../offchain/transactions/type-1";
import ProtocolBootstrapParams from "../../../offchain/protocol.json";
import { TransactionResultPanel } from "./TransactionResultPanel";
import BlacklistBootstrap from "../../../offchain/blacklist.json";
import { handleTransaction } from "../lib/tx-handler";
import { BlacklistBootstrap as BlacklistBootstrapType } from "../../../offchain/types";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    await handleTransaction(
      registerProgrammableToken(
        ...
        BlacklistBootstrap as unknown as BlacklistBootstrapType,
